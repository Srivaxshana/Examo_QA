...
//                    ExpectedConditions.visibilityOfElementLocated(By.cssSelector(".dashboard, #dashboard"))
//            ));
//        } catch (TimeoutException e) {
//            throw new AssertionError("Login failed or dashboard did not load.");
//        }
//
//        // ✅ Verify success
//        String currentUrl = driver.getCurrentUrl();
//        assertTrue(currentUrl.contains("/student-dashboard"),
//                "Expected to be on dashboard, but was: " + currentUrl);
//    }
//
//    @AfterEach
//    void tearDown() {
